    ...
    <div class="admin-container">
        ...
        <div class="main-content">
            ...
            <div id="settings" class="content-section">
                ...
                <form method="POST" action="save_settings.php" class="card" style="max-width: 700px;" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <?php $logo = getSetting('company_logo', ''); if ($logo): ?>
                            <div style="margin-bottom:10px;"><img src="<?php echo SITE_URL . '/admin/uploads/' . $logo; ?>" alt="Logo" style="max-height:60px;"></div>
                        <?php endif; ?>
                    ...
                    <div class="form-group">
                        ...
                        <?php $hero_bg = getSetting('hero_background_image', ''); if ($hero_bg): ?>
                            <div style="margin-bottom:10px;"><img src="<?php echo SITE_URL . '/admin/uploads/' . $hero_bg; ?>" alt="Fond héro" style="max-height:100px;"></div>
                        <?php endif; ?>
                    ...
                    <div class="form-group">
                        ...
                        <?php $about_img = getSetting('about_image', ''); if ($about_img): ?>
                            <div style="margin-bottom:10px;"><img src="<?php echo SITE_URL . '/admin/uploads/' . $about_img; ?>" alt="<?php echo htmlspecialchars(getSetting('about_image_alt', 'À propos')); ?>" style="max-height:100px;"></div>
                        <?php endif; ?>
                        <input type="file" id="about_image" name="about_image" accept="image/*">
                        <small>Image pour la section À propos (PNG, JPG, SVG). Max 2Mo</small>
                    </div>
                    <div class="form-group">
                        <label for="about_image_alt">Alt text image À propos</label>
                        <input type="text" id="about_image_alt" name="about_image_alt" value="<?php echo htmlspecialchars(getSetting('about_image_alt', '')); ?>" placeholder="Ex: Photo de l'équipe">
                    </div>
                    <div class="form-group">
            ...
            <div id="testimonials" class="content-section">
                ...
                <a href="add_testimonial.php" class="btn-add"><i class="bi bi-plus-circle me-1"></i><span>Ajouter un témoignage</span></a>
                <table>
                    <thead>
                        <tr>
                            <th>Nom</th>
                        ...
                        if ($result && $result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a href="edit_testimonial.php?id=<?php echo $row['id']; ?>" class="btn-edit"><i class="bi bi-pencil-square me-1"></i><span>Éditer</span></a>
